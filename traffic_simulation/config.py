...
# ─────────────────────────────────────────────────────────
#  INTERSECTION TURNS  (random exit direction)
# ─────────────────────────────────────────────────────────
TURN_WEIGHTS = {
    "straight": 55,    # continue through intersection
    "left":     18,    # turn left (from driver's perspective)
    "right":    18,    # turn right
    "uturn":     9,    # 180° U-turn back where they came from
}

# Mapping: (approach_direction, turn_choice) → exit_direction
TURN_EXIT_MAP = {
    ("north", "left"):  "east",   ("north", "right"): "west",  ("north", "uturn"): "north",
    ("south", "left"):  "west",   ("south", "right"): "east",  ("south", "uturn"): "south",
    ("east",  "left"):  "south",  ("east",  "right"): "north", ("east",  "uturn"): "east",
    ("west",  "left"):  "north",  ("west",  "right"): "south", ("west",  "uturn"): "west",
}

# ─────────────────────────────────────────────────────────
#  VISUAL EFFECTS
# ─────────────────────────────────────────────────────────
ROAD_TEXTURE_SEED     = 42
ROAD_TEXTURE_DENSITY  = 0.012     # fraction of road-area pixels with noise dots

HEADLIGHT_BEAM_LEN    = 50        # px length of headlight cone
HEADLIGHT_BEAM_SPREAD = 15        # px half-width at far end of cone
HEADLIGHT_BEAM_ALPHA  = 25        # transparency (0–255)

BRAKE_GLOW_RADIUS     = 12        # px radius of brake light glow
BRAKE_GLOW_ALPHA      = 65        # transparency

SIGNAL_GLOW_BASE      = 36        # base glow circle size (px)
SIGNAL_GLOW_OUTER     = 52        # outer pulsing glow size (px)
SIGNAL_PULSE_SPEED    = 2.5       # radians / sec for sine pulse

SHADOW_OFFSET_X       = 3         # px rightward
SHADOW_OFFSET_Y       = 4         # px downward
SHADOW_ALPHA          = 35        # transparency

COLOR_ROAD_HIGHLIGHT  = (72, 78, 88)      # subtle lighter road edge
COLOR_REFLECTOR       = (255, 255, 210)    # lane reflector dot color
